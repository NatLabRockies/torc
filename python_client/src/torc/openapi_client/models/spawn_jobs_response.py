...
class SpawnJobsResponse(BaseModel):
    """
    SpawnJobsResponse
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpawnJobsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpawnJobsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spawned_job_ids": obj.get("spawned_job_ids")
        })
        return _obj

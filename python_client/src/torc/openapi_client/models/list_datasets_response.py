...
class ListDatasetsResponse(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[DatasetModel]] = None
    offset: Optional[StrictInt] = None
    count: Optional[StrictInt] = None
    total_count: Optional[StrictInt] = None
    max_limit: Optional[StrictInt] = None
    has_more: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["items", "offset", "count", "total_count", "max_limit", "has_more"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DatasetModel.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,

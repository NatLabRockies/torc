...
class UserDataListModel(BaseModel):
    """
    UserDataListModel
    """ # noqa: E501
    user_data: List[UserDataModel]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserDataListModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserDataListModel from a dict"""
        if obj is None:
            return None

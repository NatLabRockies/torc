...
class UserDataApi:
    ...
    @validate_call
    def create_user_data_list(
        self,
        user_data_list_model: UserDataListModel,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_data_list_model: (required)
        :type user_data_list_model: UserDataListModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_user_data_list_serialize(
            user_data_list_model=user_data_list_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateUserDataListResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
            '422': "ErrorResponse",
            '500': "ErrorResponse",
    ...
    @validate_call
    def create_user_data_list_with_http_info(
        self,
        user_data_list_model: UserDataListModel,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateUserDataListResponse]:
        """create_user_data_list
    ...
    @validate_call
    def create_user_data_list_without_preload_content(
        self,
        user_data_list_model: UserDataListModel,
        _request_timeout: Union[
            None,
    ...
    def _create_user_data_list_serialize(
        self,
        user_data_list_model,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if user_data_list_model is not None:
            _body_params = user_data_list_model

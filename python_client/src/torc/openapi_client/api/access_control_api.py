...
class AccessControlApi:
    ...
    def admin_sql(
        self,
        admin_sql_request: AdminSqlRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param admin_sql_request: (required)
        :type admin_sql_request: AdminSqlRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._admin_sql_serialize(
            admin_sql_request=admin_sql_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def admin_sql_without_preload_content(
        self,
        admin_sql_request: AdminSqlRequest,
        _request_timeout: Union[
            None,
    ...
    def _admin_sql_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if admin_sql_request is not None:
            _body_params = admin_sql_request
    ...
    def list_admin_audit_log(
        ...
        _param = self._list_admin_audit_log_serialize(
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def list_admin_audit_log_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListAdminAuditLogResponse]:
        """list_admin_audit_log
    ...
    def _list_admin_audit_log_serialize(
        self,
        offset,
        limit,
        _request_auth,

...
use crate::models::{
    AccessCheckResponse, AccessGroupModel, AdminAuditLogEntry, AdminSqlRequest, AdminSqlResponse,
    ArchiveWorkflowRequest, BatchCompleteJobsRequest, BatchCompleteJobsResponse,
    ClaimActionRequest, ClaimActionResponse, ClaimJobsBasedOnResources, ClaimNextJobsResponse,
    ComputeNodeModel, ComputeNodesResources, CreateFilesResponse, CreateJobsResponse,
    CreateUserDataListResponse, DeleteCountResponse, DeleteRoCrateEntitiesResponse,
    DynamicJobsConfig, EventModel, FailureHandlerModel, FileModel, FilesModel,
    ...
    JobStatus, JobStatusCounts, JobUserDataRelationshipModel, JobsModel, ListAccessGroupsResponse,
    ListAdminAuditLogResponse, ListComputeNodesResponse, ListEventsResponse,
    ListFailureHandlersResponse, ListFilesResponse, ListJobDependenciesResponse,
    ...
    ListSlurmStatsResponse, ListUserDataResponse, ListUserGroupMembershipsResponse,
    ListWorkflowsResponse, LocalSchedulerModel, MessageResponse, ProcessChangedJobInputsResponse,
    ReloadAuthResponse, RemoteWorkerModel, ResetJobStatusResponse, ResourceRequirementsModel,
    ResultModel, RoCrateEntityModel, RunningJobModel, RunningJobsResponse,
    ScheduledComputeNodesModel, SlurmJobCorrelationModel, SlurmJobCorrelationsResponse,
    SlurmSchedulerModel, SlurmStatsModel, SpawnJobModel, SpawnJobsRequest, SpawnJobsResponse,
...
mod openapi_access_control_paths {
    pub use crate::server::live_router::{
        __path_add_user_to_group, __path_add_workflow_to_group, __path_admin_sql,
        __path_check_workflow_access, __path_create_access_group, __path_delete_access_group,
        __path_get_access_group, __path_list_access_groups, __path_list_admin_audit_log,
        __path_list_group_members, __path_list_user_groups, __path_list_workflow_groups,
        __path_reload_auth, __path_remove_user_from_group, __path_remove_workflow_from_group,
        add_user_to_group, add_workflow_to_group, admin_sql, check_workflow_access,
        create_access_group, delete_access_group, get_access_group, list_access_groups,
        list_admin_audit_log, list_group_members, list_user_groups, list_workflow_groups,
...
mod openapi_workflow_action_paths {
    pub use crate::server::live_router::{
        ...
        __path_get_workflow_actions, __path_update_workflow_action, claim_action,
        create_workflow_action, get_pending_actions, get_workflow_actions, update_workflow_action,
    };
}
...
mod openapi_workflow_paths {
    pub use crate::server::live_router::{
        ...
        __path_get_ready_job_requirements, __path_get_running_jobs,
        __path_get_slurm_job_correlations, __path_get_workflow, __path_get_workflow_status,
        ...
        get_active_task_for_workflow, get_ready_job_requirements, get_running_jobs,
        get_slurm_job_correlations, get_workflow, get_workflow_status, initialize_jobs,
...
#[openapi(
    ...
    paths(
        ...
        openapi_access_control_paths::admin_sql,
        openapi_access_control_paths::list_admin_audit_log,
        ...
        openapi_workflow_paths::get_running_jobs,

...
pub fn find_entity_for_file(
    ...
    match apis::ro_crate_api::list_ro_crate_entities(config, workflow_id, None, None, None, None) {
...
pub fn create_ro_crate_entity_for_file(
    ...
    if let Some(existing) = find_entity_for_file(config, workflow_id, file_id) {
        ...
        match apis::ro_crate_api::update_ro_crate_entity(config, entity_id, updated_entity) {
            Ok(_) => {
                debug!(
...
pub fn create_software_entities(config: &Configuration, workflow_id: i64, run_id: i64) {
    ...
    let existing_ids: std::collections::HashSet<String> =
        match apis::ro_crate_api::list_ro_crate_entities(
            config,
            workflow_id,
            None,
            None,

...
pub(crate) async fn handle_list_access_groups<C, B>(
    server: Server<C>,
    request: Request<B>,
    context: C,
) -> Response<Body>
...
pub(crate) async fn handle_create_access_group<C, B>(
    server: Server<C>,
    request: Request<B>,
    context: C,
) -> Response<Body>
...
pub(crate) async fn handle_get_access_group<C>(
    server: Server<C>,
    id: i64,
    context: C,
) -> Response<Body>
...
pub(crate) async fn handle_delete_access_group<C>(
    server: Server<C>,
    id: i64,
    context: C,
) -> Response<Body>
...
pub(crate) async fn handle_add_user_to_group<C, B>(
    server: Server<C>,
    group_id: i64,
    request: Request<B>,
    context: C,
...
pub(crate) async fn handle_list_group_members<C, B>(
    server: Server<C>,
    group_id: i64,
    request: Request<B>,
    context: C,
...
pub(crate) async fn handle_remove_user_from_group<C>(
    server: Server<C>,
    group_id: i64,
    user_name: String,
    context: C,
...
pub(crate) async fn handle_list_user_groups<C, B>(
    server: Server<C>,
    user_name: String,
    request: Request<B>,
    context: C,
...
pub(crate) async fn handle_add_workflow_to_group_by_path<C>(
    server: Server<C>,
    workflow_id: i64,
    group_id: i64,
    context: C,
...
pub(crate) async fn handle_list_workflow_groups<C, B>(
    server: Server<C>,
    workflow_id: i64,
    request: Request<B>,
    context: C,
...
pub(crate) async fn handle_remove_workflow_from_group<C>(
    server: Server<C>,
    workflow_id: i64,
    group_id: i64,
    context: C,
...
pub(crate) async fn handle_check_workflow_access<C>(
    server: Server<C>,
    workflow_id: i64,
    user_name: String,
    context: C,

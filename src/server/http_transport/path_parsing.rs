...
pub(super) fn parse_resource_id(path: &str, prefix: &str) -> Option<i64> {
...
pub(super) fn parse_workflow_ro_crate_entities_path(path: &str) -> Option<i64> {
    let workflow_id = path.strip_prefix("/torc-service/v1/workflows/")?;
...
pub(super) fn parse_workflow_remote_workers_collection_path(path: &str) -> Option<i64> {
    let workflow_id = path.strip_prefix("/torc-service/v1/workflows/")?;
...
pub(super) fn parse_workflow_remote_worker_item_path(path: &str) -> Option<(i64, String)> {
    let suffix = path.strip_prefix("/torc-service/v1/workflows/")?;
...
pub(super) fn parse_workflow_dot_graph_path(path: &str) -> Option<(i64, String)> {
    let suffix = path.strip_prefix("/torc-service/v1/workflows/")?;
...
pub(super) fn parse_workflow_actions_collection_path(path: &str) -> Option<i64> {
    parse_workflow_suffix_path(path, "/actions")
}

pub(super) fn parse_workflow_pending_actions_path(path: &str) -> Option<i64> {
    parse_workflow_suffix_path(path, "/actions/pending")
}

pub(super) fn parse_workflow_action_claim_path(path: &str) -> Option<(i64, i64)> {
    let suffix = path.strip_prefix("/torc-service/v1/workflows/")?;
...
pub(super) fn parse_workflow_claim_jobs_resources_path(path: &str) -> Option<(i64, i64)> {
    let suffix = path.strip_prefix("/torc-service/v1/workflows/")?;
...
pub(super) fn parse_job_status_run_path(
    path: &str,
    prefix: &str,
    middle: &str,
...
pub(super) fn parse_job_start_path(path: &str) -> Option<(i64, i64, i64)> {
...
pub(super) fn parse_job_retry_path(path: &str) -> Option<(i64, i64)> {
    let suffix = path.strip_prefix("/torc-service/v1/jobs/")?;

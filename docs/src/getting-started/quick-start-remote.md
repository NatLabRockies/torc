...
- [Remote Workers Guide](../specialized/remote/remote-workers.md) - Detailed configuration and
  troubleshooting
- [Creating Workflows](../core/workflows/creating-workflows.md) - Workflow specification format
- [Resource Monitoring](../core/monitoring/resource-monitoring.md) - Track CPU/memory usage per job

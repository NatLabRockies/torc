...
Base.@kwdef mutable struct SlurmJobCorrelationsResponse <: OpenAPI.APIModel
    ...
    function SlurmJobCorrelationsResponse(count, has_more, items, max_limit, offset, total_count, )
...
const _property_types_SlurmJobCorrelationsResponse = Dict{Symbol,String}(Symbol("count")=>"Int64", Symbol("has_more")=>"Bool", Symbol("items")=>"Vector{SlurmJobCorrelationModel}", Symbol("max_limit")=>"Int64", Symbol("offset")=>"Int64", Symbol("total_count")=>"Int64", )
...
function OpenAPI.validate_properties(o::SlurmJobCorrelationsResponse)
    OpenAPI.validate_property(SlurmJobCorrelationsResponse, Symbol("count"), o.count)
    OpenAPI.validate_property(SlurmJobCorrelationsResponse, Symbol("has_more"), o.has_more)
    OpenAPI.validate_property(SlurmJobCorrelationsResponse, Symbol("items"), o.items)
    OpenAPI.validate_property(SlurmJobCorrelationsResponse, Symbol("max_limit"), o.max_limit)
    OpenAPI.validate_property(SlurmJobCorrelationsResponse, Symbol("offset"), o.offset)
    OpenAPI.validate_property(SlurmJobCorrelationsResponse, Symbol("total_count"), o.total_count)
end

function OpenAPI.validate_property(::Type{ SlurmJobCorrelationsResponse }, name::Symbol, val)

    if name === Symbol("count")
        OpenAPI.validate_param(name, "SlurmJobCorrelationsResponse", :format, val, "int64")
    end
